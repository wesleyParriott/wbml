...
func infof(message string, values ...interface{})    { log.Printf(infoTag+message, values...) }
func warningf(message string, values ...interface{}) { log.Printf(warningTag+message, values...) }
func debugf(message string, values ...interface{})   { log.Printf(debugTag+message, values...) }
func fatalf(message string, values ...interface{})   { log.Fatalf(fatalTag+message, values...) }
